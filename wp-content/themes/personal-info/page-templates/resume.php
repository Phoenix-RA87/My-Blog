        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-lg-6">
                    ...
                    <h3 class="title title-resume work"><?php esc_html_e('Work','personal-info');  ?></h3>
                    <div class="block-grey">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="font-weight-m width-td"><?php esc_html_e('Name','personal-info');  ?></td>
                                                <td><?php
                                                    $resume_education_info_2 = json_decode(get_post_meta(get_the_ID(), 'resume_education_info_2', true ));
                                                    if( !is_object($resume_education_info_2)){
                                                        $resume_education_info_2 = (object) array('name'=>"Dummny Name",'address'=>"Address",'period'=>"Period",'label'=>"lebel 1",'description'=>"Description Nesciunt saepe lacinia reprehenderit pellentesque, vehicula? Vulputate");
                                                     } 
                                                    echo esc_attr($resume_education_info_2->name);    
                                                ?></td>
                                            </tr>
                                            <tr>
                                                <td class="font-weight-m"><?php esc_html_e('Address','personal-info');  ?></td>
                                                <td><?php echo esc_attr($resume_education_info_2->address);  ?></td>
                                            </tr>
                                            <tr>
                                                <td class="font-weight-m"><?php esc_html_e('Period','personal-info');  ?></td>
                                                <td><?php echo esc_attr($resume_education_info_2->period);  ?></td>
                                            </tr>
                                            <tr>
                                                <td class="font-weight-m"><?php esc_html_e('Level','personal-info');  ?></td>
                                                <td><?php echo esc_attr($resume_education_info_2->label);  ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <p><?php echo esc_attr($resume_education_info_2->description);  ?></p>
                                </div></div><div class="owl-item owl-item " >
                                </div></div></div>                                
                        </div>
                    </div>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    $resume_work_info_2 = json_decode(get_post_meta(get_the_ID(), 'resume_work_info_2', true )); 
                                                    if( !is_object($resume_work_info_2)){
                                                        $resume_work_info_2 = (object) array('company_name'=>"Your Company",'address'=>"Your Address",'period'=>"Period II",'post'=>"Post Name",'description'=>"nostra et esse reiciendis fugiat at deleniti aut consectetur consequatur taciti soluta");
                                                     }
                                                    echo esc_attr($resume_work_info_2->company_name);    
                                                ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="font-weight-m"><?php esc_html_e('Address','personal-info');  ?></td>
                                            <td><?php echo esc_attr($resume_work_info_2->address);  ?></td>
                                        </tr>
                                        <tr>
                                            <td class="font-weight-m"><?php esc_html_e('Period','personal-info');  ?></td>
                                            <td><?php echo esc_attr($resume_work_info_2->period);  ?></td>
                                        </tr>
                                        <tr>
                                            <td class="font-weight-m"><?php esc_html_e('Post','personal-info');  ?></td>
                                            <td><?php echo esc_attr($resume_work_info_2->post);  ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <p><?php echo esc_attr($resume_work_info_2->description);  ?></p>
                            </div> 
                            </div>
                            </div></div>                                     
                    </div>
