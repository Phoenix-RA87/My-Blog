        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-1 col-lg-1 text-right">
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="btn-close hover-animate ajaxcontent-close">
                                ...
                                <td class="text-right">
                                    <?php
                                        ...
                                        if( !is_object($profile_info)){
                                            $profile_info = (object) array('name'=>"Roman Andrey",'date_of_birth'=>"29-10-20",'email'=>"roman_andryushenka@mail.ru",'address'=>"Krasnodar, Krasnodarskiy kray, Russia",'phone'=>"938 521 77-87",'website'=>"http://MyBlog");
                                        }
 ...
 <?php } ?>
    ...
    <section class="info border-bottom padding-block text-center">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    <h3 class="title"><?php esc_html_e('Regular in use!','personal-info');  ?></h3>
                </div>
            </div>
            <!-- end row -->
            <!-- start row -->
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                       ...
                       if( is_array( $what_im_doing_title)) {
                        ...
                        ?>
                        <div class="circle-block col-md-2 ">
