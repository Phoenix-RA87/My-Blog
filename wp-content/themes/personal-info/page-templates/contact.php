                	...
                	while ( have_posts() ) : the_post(); ?>
                        ...
                        <div class="social">
                            <ul class="animated fadeIn visible" data-animation="fadeIn" data-animation-delay="600">
                                 <?php if(get_theme_mod('facebook_url')): ?><li><a class="facebook ukie-icons hover-animate" href="<?php echo esc_url(get_theme_mod('facebook_url')); ?>" title="VK" target="_blank"><i class="fa fa-vk"></i></a></li><?php endif; ?>
                            ...
                            <?php if(get_theme_mod('linkedin_url')): ?><li><a class="linkedin ukie-icons hover-animate" href="<?php echo esc_url(get_theme_mod('linkedin_url')); ?>" title="LinkedIn" target="_blank"><i class="fa fa-linkedin"></i></a></li><?php endif; ?>
                            <?php if(get_theme_mod('google_plus_url')): ?><li><a class="google-plus ukie-icons hover-animate" href="<?php echo esc_url(get_theme_mod('google_plus_url'));  ?>" title="Odnoklassniki" target="_blank"><i class="fa fa-odnoklassniki"></i></a></li><?php endif; ?>
                            <?php if(get_theme_mod('wordpress_url')): ?><li><a class="wp ukie-icons hover-animate" href="<?php echo esc_url(get_theme_mod('wordpress_url')); ?>" title="WordPress" target="_blank"><i class="fa fa-wordpress"></i></a></li><?php endif; ?>
                            ...
                            <li><a target="_blank" class="github ukie-icons" href="<?php  echo esc_url(get_theme_mod('upwork_url')); ?>" title="GitHub" target="_blank" ><i class="fa fa-github"></i></a></li>
                            <?php endif; ?>  
