...
function perosnal_info_scripts() {
	...
	/** for portfolio page */
	wp_enqueue_style('fancyapps', '//cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css');
	wp_enqueue_script( 'fancyapps-js', '//cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js', array('jquery',), '20151215', true );
