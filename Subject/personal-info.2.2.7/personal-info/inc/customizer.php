...
function personal_info_customize( $wp_customize ) {
			...
			//add the Slack link
			$wp_customize->add_setting('slack_url',array(
				'default'	=>'',
				'sanitize_callback' => 'esc_url_raw'
			));
			$wp_customize->add_control('slack_url',array(
				'label'		=> esc_html__('Slack','personal-info'),
				'section'	=> 'social',
				'priority'	=>	34,
				'type'		=>	'url'
			));
			...
			$wp_customize->add_control('skype_url',array(
				'label'		=> esc_html__('Skype','personal-info'),
				'section'	=> 'social',
				'priority'	=>	34,
				'type'		=>	'url'
			));
			...
			$wp_customize->add_control('instagram_url',array(
				'label'		=> esc_html__('Instagram','personal-info'),
				'section'	=> 'social',
				'priority'	=>	34,
				'type'		=>	'url'
			));
			...
			$wp_customize->add_control('upwork_url',array(
				'label'		=> esc_html__('Upwork','personal-info'),
				'section'	=> 'social',
				'priority'	=>	34,
				'type'		=>	'url'
			));
